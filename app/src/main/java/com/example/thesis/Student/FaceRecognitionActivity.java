...
import com.example.thesis.Drawing.BorderedText;
import com.example.thesis.Drawing.MultiBoxTracker;
import com.example.thesis.Drawing.OverlayView;
...
public class FaceRecognitionActivity extends AppCompatActivity implements ImageReader.OnImageAvailableListener {
    ...
    public void performFaceRecognition(Face face,Bitmap input){
        ...
        final FaceClassifier.Recognition result = faceClassifier.recognizeImage(crop, true);
